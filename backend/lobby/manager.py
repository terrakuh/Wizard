...
class Manager:
	def __init__(self, max_lobbies: int = 8, inactive_timeout: timedelta = timedelta(minutes=20)):
		self._lock = RLock()
	...
	def create_lobby(self, id: int, code_length: int = 5):
